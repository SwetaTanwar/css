...
## [0.15.0](https://github.com/SwetaTanwar/css/compare/css-v0.14.1...css-v0.15.0) (2025-11-18)
...
* add `allow*` options to `use-baseline` rule ([#310](https://github.com/SwetaTanwar/css/issues/310)) ([e8dc57d](https://github.com/SwetaTanwar/css/commit/e8dc57d91828150f8221de48065993c6478e02ca))
...
* add `no-unmatchable-selectors` rule ([#301](https://github.com/SwetaTanwar/css/issues/301)) ([adaa397](https://github.com/SwetaTanwar/css/commit/adaa397db27c518d04bc2218f8a44dc088e06ddb))
...
* add `selector-complexity` rule ([#252](https://github.com/SwetaTanwar/css/issues/252)) ([2bd29c4](https://github.com/SwetaTanwar/css/commit/2bd29c4ff0dcd145e0f5c0a63a64d70f31ab90df))
...
* add support for `getLocFromIndex` and `getIndexFromLoc` ([#167](https://github.com/SwetaTanwar/css/issues/167)) ([3baeacf](https://github.com/SwetaTanwar/css/commit/3baeacfe806a39763bbb63106a2fd750d2e407a1))
...
* allow relative-size and global values in relative-font-units ([#214](https://github.com/SwetaTanwar/css/issues/214)) ([933d71c](https://github.com/SwetaTanwar/css/commit/933d71c61ca3ae5eb97474df8cc9f94a13a9a273))
...
* correct location reporting for `!important` in `no-important` rule ([#286](https://github.com/SwetaTanwar/css/issues/286)) ([33ea905](https://github.com/SwetaTanwar/css/commit/33ea9056be5946894be35616cb95662ec6aad4b2))
* correct message for functions in `use-baseline` rule ([#297](https://github.com/SwetaTanwar/css/issues/297)) ([cc0dff7](https://github.com/SwetaTanwar/css/commit/cc0dff76da0eb1e6c05c31cd8aecf3b6afa5bd0d))
* correct parent typing for rule visitors ([#313](https://github.com/SwetaTanwar/css/issues/313)) ([17046d0](https://github.com/SwetaTanwar/css/commit/17046d0178272e2b12291d32176bcbc9326795a5))
* correct the return type of `applyInlineConfig` ([#281](https://github.com/SwetaTanwar/css/issues/281)) ([386f42a](https://github.com/SwetaTanwar/css/commit/386f42a1f40c1abb59090d48750d18ffe72917fe))
* detect prefixed [@keyframes](https://github.com/keyframes) in no-duplicate-keyframe-selectors ([11ae50f](https://github.com/SwetaTanwar/css/commit/11ae50fb404d1620309921ebadec006498db4091))
* detect prefixed `[@keyframes](https://github.com/keyframes)` in `no-duplicate-keyframe-selectors` ([#251](https://github.com/SwetaTanwar/css/issues/251)) ([11ae50f](https://github.com/SwetaTanwar/css/commit/11ae50fb404d1620309921ebadec006498db4091))
...
* disallow extra properties in rule options ([#299](https://github.com/SwetaTanwar/css/issues/299)) ([baf36e2](https://github.com/SwetaTanwar/css/commit/baf36e26728b512b32a6220f50183757ebbc9056))
...
* enforce unique items in the options of `prefer-logical-properties` ([#176](https://github.com/SwetaTanwar/css/issues/176)) ([b720cf8](https://github.com/SwetaTanwar/css/commit/b720cf89b611eca7b5778d11bdc4c872813209c3))
* enforce valid `allow*` values in `prefer-logical-properties` rule ([#311](https://github.com/SwetaTanwar/css/issues/311)) ([23caee3](https://github.com/SwetaTanwar/css/commit/23caee38eef8231e2bbdd4c2c651e0645440b85a))
* Ensure languageOptions.customSyntax is serializable ([#212](https://github.com/SwetaTanwar/css/issues/212)) ([7f82110](https://github.com/SwetaTanwar/css/commit/7f82110ea633e1524d083434468052a7942c7236))
...
* handle all CSS newline types in `CSSSourceCode` ([#275](https://github.com/SwetaTanwar/css/issues/275)) ([2d0eec6](https://github.com/SwetaTanwar/css/commit/2d0eec6ae06bd8561ed27d5912066278f763ad01))
* handle all CSS newlines in rules ([#280](https://github.com/SwetaTanwar/css/issues/280)) ([ed0c0f1](https://github.com/SwetaTanwar/css/commit/ed0c0f135540781439bd12216583f5cd7d1ff0e4))
* handle missing declaration state in `no-invalid-properties` ([#290](https://github.com/SwetaTanwar/css/issues/290)) ([4120774](https://github.com/SwetaTanwar/css/commit/4120774e7e641ea8f6d34a70a39c0969c71ba33d))
...
* no-invalid-properties false positives for var() in functions ([#227](https://github.com/SwetaTanwar/css/issues/227)) ([268c7f0](https://github.com/SwetaTanwar/css/commit/268c7f03b981025e97c1489848212b5e9a27a9ab))
...
* update baseline data ([61480f0](https://github.com/SwetaTanwar/css/commit/61480f00ffe2e7812be183ec1642134154bfb105))
* update baseline data ([fb65800](https://github.com/SwetaTanwar/css/commit/fb658009ef6d92e1ad11c0ae9d57ba5c20e67f55))
...
* update baseline data ([#245](https://github.com/SwetaTanwar/css/issues/245)) ([a009bb7](https://github.com/SwetaTanwar/css/commit/a009bb7ce58a29de9063bf4059ef217261449bd2))
* update baseline data ([#254](https://github.com/SwetaTanwar/css/issues/254)) ([ff77374](https://github.com/SwetaTanwar/css/commit/ff773743c8397d509bf215aa743abb28b92b94f5))
* update baseline data ([#257](https://github.com/SwetaTanwar/css/issues/257)) ([b5414d3](https://github.com/SwetaTanwar/css/commit/b5414d3e4bbcac9fd27bcc3c220d1b50aa86e8b3))
* update baseline data ([#267](https://github.com/SwetaTanwar/css/issues/267)) ([da37950](https://github.com/SwetaTanwar/css/commit/da3795005f9b1492c056f5c6950eb7c3252fb4d8))
* update baseline data ([#287](https://github.com/SwetaTanwar/css/issues/287)) ([73734bb](https://github.com/SwetaTanwar/css/commit/73734bb9f6b756d5f993b5b0b13c455d9e39f70d))
* update baseline data ([#296](https://github.com/SwetaTanwar/css/issues/296)) ([0f6725f](https://github.com/SwetaTanwar/css/commit/0f6725f17a97273b97ca62b2d25cee5ca212df83))
* update baseline data ([#306](https://github.com/SwetaTanwar/css/issues/306)) ([2f44739](https://github.com/SwetaTanwar/css/commit/2f4473972a64eb18e64ae997cff8e45718a81b18))
* update baseline data ([#321](https://github.com/SwetaTanwar/css/issues/321)) ([61090f9](https://github.com/SwetaTanwar/css/commit/61090f9243ee3dbb74ff53ce3db405ff31ad0ea1))
* update baseline data ([#326](https://github.com/SwetaTanwar/css/issues/326)) ([cddbf92](https://github.com/SwetaTanwar/css/commit/cddbf92dc3d66b392234bcff40224aab89e09d26))
